...
import (
	"github.com/ngonghi/vian-backend/internal/http/admin/requests"
	adminResponse "github.com/ngonghi/vian-backend/internal/http/admin/responses"
	commonResponse "github.com/ngonghi/vian-backend/internal/http/common/responses"
	"go.uber.org/zap"
	"strconv"
	"strings"
...
func (handler *Handler) AdminUserGet(c *gin.Context) {
	...
	if model == nil {
		c.JSON(http.StatusNotFound, commonResponse.NewNotFoundError("user"))
	}
