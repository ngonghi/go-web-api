...
func (repository *AdminUserRepository) FindByID(ctx context.Context, id int64) (*models.AdminUser, error) {
...
func (repository *AdminUserRepository) Delete(ctx context.Context, id int64) error {
